...
// interface IFormInput extends UserData {
//   firstName: string;
//   lastName: string;
//   age: number;
//   gender: GenderEnum;
        ...
        <div className='box_form'>
          ...
          <div>
            ...
            <div className='form_sign_up' >
              ...
              <input className='input' type="date" placeholder="Day/Month/Year" />
              <div className='check'>
                <input className='checking' type="radio" value={'Male'} />Male
                <input className='checking' type="radio" value="Female" />Female
                <input className='checking' type="radio" value="Other" />Other
              </div>
              <div className='check'>
                <input className='checking' type="checkbox" placeholder="check" />
              ...
              <button className='btn_submit' onClick={() => handleClickSignup(email, pwd)} > Sign up</button>
